...
class QueryTransferInListRequest(RpcRequest):
	...
	def get_SubmissionStartDate(self): # Long
		return self.get_query_params().get('SubmissionStartDate')

	def set_SubmissionStartDate(self, SubmissionStartDate):  # Long
		self.add_query_param('SubmissionStartDate', SubmissionStartDate)
	def get_SubmissionEndDate(self): # Long
		return self.get_query_params().get('SubmissionEndDate')

	def set_SubmissionEndDate(self, SubmissionEndDate):  # Long
	...
	def get_SimpleTransferInStatus(self): # String
		return self.get_query_params().get('SimpleTransferInStatus')

	def set_SimpleTransferInStatus(self, SimpleTransferInStatus):  # String
